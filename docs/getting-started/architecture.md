...
![KDP Architecture Diagram](../assets/images/kdp_architecture.png)
...
- [Feature Processing Guide](../features/overview.md) - Deep dive into feature handling
- [Distribution-Aware Encoding](../advanced/distribution-aware-encoding.md) - Smart numerical processing
- [Tabular Attention](../advanced/tabular-attention.md) - Learn feature relationships
- [Auto-Configuration](../optimization/auto-configuration.md) - Let KDP configure itself
- [Integrations](../integrations/tensorflow.md) - Connect KDP to other tools

---

<div class="prev-next">
  <a href="motivation.md" class="prev">← Motivation</a>
  <a href="../features/overview.md" class="next">Feature Types →</a>
</div>
