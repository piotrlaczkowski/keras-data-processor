    ...
    generate_model_diagram(
        "time_series_with_lags",
        {
            "sales": TimeSeriesFeature(
                ...
                sort_ascending=True,
                group_by="group_id",
                lag_config={"lags": [1, 2, 3], "keep_original": True},
            ),
            "date": FeatureType.DATE,
            "group_id": FeatureType.STRING_CATEGORICAL,
        },
    ...
    generate_model_diagram(
        "time_series_moving_average",
        {
            "sales": TimeSeriesFeature(
                ...
                sort_ascending=True,
                group_by="group_id",
                window_config={"windows": [3, 5, 7], "keep_original": True},
            ),
            "date": FeatureType.DATE,
            "group_id": FeatureType.STRING_CATEGORICAL,
        },
    ...
    generate_model_diagram(
        "time_series_differencing",
        {
            "sales": TimeSeriesFeature(
                ...
                sort_ascending=True,
                group_by="group_id",
                diff_config={"periods": [1, 2], "keep_original": True},
            ),
            "date": FeatureType.DATE,
            "group_id": FeatureType.STRING_CATEGORICAL,
        },
    ...
    generate_model_diagram(
        "time_series_all_features",
        {
            "sales": TimeSeriesFeature(
                ...
                sort_ascending=True,
                group_by="group_id",
                lag_config={"lags": [1, 2], "keep_original": True},
                window_config={"windows": [3, 5], "keep_original": True},
                diff_config={"periods": [1], "keep_original": True},
            ),
            "date": FeatureType.DATE,
            "group_id": FeatureType.STRING_CATEGORICAL,
        },
